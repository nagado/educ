...
public:
  ...
  virtual void updatePosition(const std::vector<std::vector<int>> thing_borders = {}, const int thing_speed = 0, const double thing_angle = 0) {}
  ...
  virtual std::vector<std::vector<int>> getBorders() const = 0;//maybe return vector of Vertices
